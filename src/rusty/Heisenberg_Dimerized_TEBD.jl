...
let 
    ...
    for t in 0 : τ : ttotal
        ...
        h5open("../../data/Heisenberg_Dimerized_TEBD_Time$(ttotal)_Delta$(delta)_J2$(J2).h5", "w") do file
    ...
    h5open("../../data/Heisenberg_Dimerized_TEBD_Time$(ttotal)_Delta$(delta)_J2$(J2).h5", "r+") do file
        write(file, "Psi", ψ)
